...
This React app was bootstrapped using `create-react-app`.
...
The following command will run the Docker image, mapping the react application port of 80 to the external port 8080:
